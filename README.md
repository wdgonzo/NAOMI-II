...
4. Analogies, Yes/No
5. New Word Implementation
6. Working (Contextual) Memory
7. Long-Term Memory (stories, ideas, concepts, people) //The trouble is this is linked with the lexicon
8. Conversations affecting Lexicon and Long-Term Memory
9. Multi-Language Support
10. Natural Language (Refactor Tree to be slightly more lenient to Natural)